...
| escape | `escHtml`, `safeContentUrl` | All-5-char HTML escaper plus the URL guard: `safeContentUrl` returns a normalized http(s) href for DOM APIs (`el.href = …`) or `null` on reject. |
